...
public class ContaTerminal {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Exibir a mensagem final para o cliente, seguindo o modelo: "Olá [nome do cliente], obrigado por criar uma conta em nosso banco, sua agência é [número da agência], conta [número da conta] e seu saldo [saldo da conta] já está disponível para saque."
        scanner.close();
        // Fechar o Scanner
    }
